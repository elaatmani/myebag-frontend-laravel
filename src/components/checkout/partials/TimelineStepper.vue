<template>
  <div>
    ...
    <div class="tw-overflow-hidden tw-rounded-full dark:tw-bg-gray-600 tw-bg-gray-200">
      <div :class="[step == 2 && '!tw-w-1/3', step == 3 && '!tw-w-2/3', step == 4 && '!tw-w-full']" class="tw-w-10 tw-h-2 tw-duration-500 tw-rounded-full tw-bg-violet-500 dark:tw-bg-violet-500"></div>
    </div>
